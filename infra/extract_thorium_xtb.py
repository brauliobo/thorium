#!/usr/bin/env python3
"""Extract Thorium-branded <translation> additions from the legacy
...
Invocation (run once, output is committed):
    python3 infra/extract_thorium_xtb.py other/multi-language-translate.patch \
        src/chrome/app/resources/thorium_additions/

Each generated file contains only the Thorium-added <translation> lines for
a given locale/bundle. `infra/merge_thorium_xtb.py` splices them back into
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print('usage: extract_thorium_xtb.py <patch> <out_dir>', file=sys.stderr)
        sys.exit(1)
