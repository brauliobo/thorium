## Alacrium Pak Customizer

<img src="https://github.com/brauliobo/alacrium/blob/main/logos/STAGING/pak.png">
...
These are copied when running ./setup.sh during the Alacrium build to the //chromium/src/out/alacrium dir for the installer to include.
