...
My primary job as the founder and main dev of Alacrium is rebasing Alacrium to match newer upstream Chromium versions.
...
We have a [bookmarks file](https://github.com/brauliobo/alacrium/blob/main/infra/ALACRIUM_DEV_BOOKMARKS.html) located in __//infra__
which has a (not super well organized) bookmark list of all the files alacrium uses.

The bookmarks file can be imported at chrome://bookmarks. Each file will be at the current Alacrium revision, and it will also show
